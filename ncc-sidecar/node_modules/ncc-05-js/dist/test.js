import { NCC05Publisher, NCC05Resolver, NCC05Group, isPrivateLocator } from './index.js';
...
async function test() {
    ...
    const privateWrappedEvent = await publisher.publishWrapped(relays, sk, [pk], payloadPrivate, { identifier: 'private-wrapped-test', privateLocator: true });
    ...
    const legacyWrappedEvent = await publisher.publishWrapped(relays, sk, [pk], payloadPrivate, 'legacy-wrapped-test');
